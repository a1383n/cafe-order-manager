...
public class Drink {
    public static class Hot extends Product {
        public static final Map<String, List<Ingredient>> list = new HashMap<>() {
            {
                put("Coffee", List.of(new Ingredient(Ingredients.COFFEE, 2), new Ingredient(Ingredients.WATER, 1)));
                put("Tea", List.of(new Ingredient(Ingredients.TEA, 2), new Ingredient(Ingredients.WATER, 1)));
                put("Hot chocolate", List.of(new Ingredient(Ingredients.CHOCOLATE, 2), new Ingredient(Ingredients.WATER, 1)));
            }
        };
    ...
    public static class Cold extends Product {
        public static final Map<String, List<Ingredient>> list = new HashMap<>() {
            {
                put("Soda", List.of(new Ingredient(Ingredients.SODA, 2)));
                put("Water", List.of(new Ingredient(Ingredients.WATER, 2)));
            }
        };
