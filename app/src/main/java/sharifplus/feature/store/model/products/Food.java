...
public class Food extends Product {
    public static final Map<String, List<Ingredient>> list = new HashMap<>() {
        {
            put("Pizza", List.of(new Ingredient(Ingredients.FLOUR, 2), new Ingredient(Ingredients.EGG, 2)));
            put("Berger", List.of(new Ingredient(Ingredients.MEAT, 2), new Ingredient(Ingredients.BREAD, 3)));
            put("Steak", List.of(new Ingredient(Ingredients.MEAT, 4)));
            put("Fried Chicken", List.of(new Ingredient(Ingredients.CHICKEN, 1), new Ingredient(Ingredients.EGG, 2)));
        }
    };
